...
package local_project.exportar_lectura_uraba_0_1;
...
/**
 * Job: exportar_lectura_uraba Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class exportar_lectura_uraba implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "exportar_lectura_uraba";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				exportar_lectura_uraba.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(exportar_lectura_uraba.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class secuencia_actaStruct implements routines.system.IPersistableRow<secuencia_actaStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_exportar_lectura_uraba = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_exportar_lectura_uraba = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_exportar_lectura_uraba.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_exportar_lectura_uraba.length == 0) {
   					commonByteArray_LOCAL_PROJECT_exportar_lectura_uraba = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_exportar_lectura_uraba = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_exportar_lectura_uraba, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_exportar_lectura_uraba, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_exportar_lectura_uraba) {
...
secuencia_actaStruct secuencia_acta = new secuencia_actaStruct();
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="C:/Users/Administrador/OneDrive - ingeomega.com/03_Procesos Informáticos/11 Reportes Maxivos/02 Reporte Secuencias Lecturas Uraba/Secuencias De Lectura Uraba.xlsx";
		int nb_line_tFileOutputExcel_1 = 0;
		org.talend.ExcelTool xlsxTool_tFileOutputExcel_1 = new org.talend.ExcelTool();
		
		xlsxTool_tFileOutputExcel_1.setSheet("Secuencias De Lectura Uraba");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:zW91qqQOQBbViAAn11Oog9rLWBkO8Pc8F7WgSlcnL8RmcjF5BuTMEKI=");
...
+"_ACTUAL,(INSTR(FECHA_LECTURA_ACTUAL,'-')+1),2)) = (select COD_MES from consulta_fecha_lectura_uraba)\nAND `ID_ZONA_OPERA"
 ...
 */
    ...
    public static void main(String[] args){
        final exportar_lectura_uraba exportar_lectura_urabaClass = new exportar_lectura_uraba();

        int exitCode = exportar_lectura_urabaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = exportar_lectura_uraba.class.getClassLoader().getResourceAsStream("local_project/exportar_lectura_uraba_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = exportar_lectura_uraba.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : exportar_lectura_uraba");
        }
...
/************************************************************************************************
 *     102178 characters generated by Talend Open Studio for Big Data 
 *     on the 23 de mayo de 2022 10:13:05 AM COT
 ************************************************************************************************/