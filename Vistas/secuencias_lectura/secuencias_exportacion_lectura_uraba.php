...
//Elimina SQL 
$sql="DELETE FROM consulta_fecha_lectura_uraba" ; 
...
//Conexión a la Base de Datos
   ...
   $sql="INSERT INTO consulta_fecha_lectura_uraba(Id_acta,COD_ANO,COD_MES) VALUES('1','$ANO1','$MES1')";
 ...
 echo exec('C:\Windows\System32\cmd.exe /C START C:\xampp\htdocs\ingeomega\botonesTalend\exportar_lectura_uraba\exportar_lectura_uraba\exportar_lectura_uraba_run.bat');
