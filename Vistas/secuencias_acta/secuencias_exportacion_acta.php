...
<head>
    ...
    <title>Informe Acta Lectura</title>
</head>
<?php
...
//Elimina SQL 
$sql="DELETE FROM consulta_fecha_acta" ; 
...
//Conexión a la Base de Datos
   ...
   $sql="INSERT INTO consulta_fecha_acta(Id_acta,COD_ANO,COD_MES) VALUES('1','$ANO1','$MES1')";
  ...
  echo exec('C:\Windows\System32\cmd.exe /C START C:\xampp\htdocs\ingeomega\botonesTalend\exportar_acta\exportar_acta\exportar_acta_run.bat');
