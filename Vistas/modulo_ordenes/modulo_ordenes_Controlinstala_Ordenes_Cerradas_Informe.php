...
//Titulo del excel
header("Content-Disposition: attachment; filename=Ordenes_Cerradas_Mes_$MES1.xls");
...
where
FECHALEGALIZATION>=concat('$ANO1','$MES1','01') 
and  FECHALEGALIZATION<=concat('$ANO1','$MES1','31')
and ESTADO = 8
