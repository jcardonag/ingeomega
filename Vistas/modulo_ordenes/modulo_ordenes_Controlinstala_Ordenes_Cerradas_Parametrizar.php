...
<!--termino DRGP -->
  ...
  <form action="modulo_ordenes_Controlinstala_Ordenes_Cerradas_Informe.php" enctype="multipart/form-data" method="post">
   <center> 
  ...
  <p>&nbsp;</p>
   <BR>
    <BR>
        <h6>Ordenes Cerradas De Todas Las Regiones</h6> 
...
<p></p>
       <td><a type="button"  href="reporte_powerbi_modulo_ordenes.php" title="Gráfica de seguimiento de las ordenes comerciales" class="btn btn-outline-info">Ordenes Comerciales</a><br></td>
