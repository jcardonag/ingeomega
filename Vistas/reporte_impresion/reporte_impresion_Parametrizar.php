...
//*******************************  
 //consulta para mostrar los combos
 //********************************   
$sql5="SELECT  ciclo from ciclos_lecturas";//consulta el codigo y la descripción del mes
...
if ($result5->num_rows > 0) //si la variable tiene al menos 1 fila entonces seguimos con el codigo
{
  ...
  {
        $combobit5 .=" <option value='".$row5['ciclo']."'>".$row5['ciclo']."</option>"; //concatenamos el los options para luego ser insertado en el HTML
      }
    }
...
<form action="reporte_impresion_Informe.php" enctype="multipart/form-data" method="post">
 <center> 
  <div class="card-body" style="width: 50rem" >
    <h2>INFORME DE FACTURACIÓN INGEOMEGA</h2>
    <p>&nbsp;</p>
    <div class="card-body" style="width: 20rem" >
      ...
      <h6>Ciclo</h6> 
      <div class="form-group">
        <select  name="ciclo" class="form-control" required autofocus>
          <option value=""><?php echo $combobit5; ?></option>
        </select>
      </div>
