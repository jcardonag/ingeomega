...
<head>
	...
	<title>Ordenes Comerciales Con Precio</title>
<!-- carga web DRGP -->
...
?>
	...
	<form action="modulo_ordenes_conk_exportacion_precio.php" enctype="multipart/form-data" method="post">
	<center> 
		<div class="card-body" style="width: 50rem" >
		<h2>ORDENES COMERCIALES CON PRECIO INGEOMEGA</h2>
		<p>&nbsp;</p>
