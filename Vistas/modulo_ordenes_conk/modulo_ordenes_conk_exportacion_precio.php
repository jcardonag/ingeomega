...
<head>
    ...
    <title>Modulo Ordenes Con Precio</title>
</head>
<?php
...
//Elimina SQL 
$sql="DELETE FROM consulta_fecha_k_dispersion_ordcomerciales" ; 
...
//Conexión a la Base de Datos
   ...
   $sql="INSERT INTO consulta_fecha_k_dispersion_ordcomerciales(Id_acta,COD_ANO,COD_MES) VALUES('1','$ANO1','$MES1')";
...
ini_set('max_execution_time', 10000);
  ...
  echo exec('C:\Windows\System32\cmd.exe /C START C:\xampp\htdocs\ingeomega\botonesTalend\ordenes_comerciales_k_precio\ordenes_comerciales_k_precio\ordenes_comerciales_k_precio_run.bat');
