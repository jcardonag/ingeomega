	 	...
	 	<center>
			<div class="card-body" style="width: 25rem" >
			 	<?php 
			  	...
			  	<br>
			  	<h6>Pregunta</h6>
			 	<input class="form-control" type="text" name="preguntarecuper" value="<?php echo $row['preguntarecuper']; ?>" readonly>
			 	<?php 
				}
				 ?>
				 <br>
				 <h6>Respuesta</h6>
				 <input class="form-control" type="text" id="respuesta" name="respuesta" placeholder="Ingrese Respuesta" autocomplete="off" required autofocus>
				 <br>
				<input type="submit" class="btn btn-secondary" name="" value="Enviar">
