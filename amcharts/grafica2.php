<?php 
  include_once '../Controlador/HeaderGraficas.php';
 ?>
<!DOCTYPE HTML >
<html>
    <head>
        ...
        <div class="card-body" style="width: 19rem">
        <input  class="form-control" type="text" name="opcion" placeholder="Rol" required>
